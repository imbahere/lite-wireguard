...
function installQuestions() {
	echo "Thank you for using Lite WireGuard by imbahere!"
	echo "The git repository is available at: https://github.com/imbahere/lite-wireguard"
	echo ""
	...
	echo ""
	echo "Okay, that was all I needed. We are ready to setup your Lite WireGuard server now."
...
wget -q -O /usr/local/bin/menu 'https://raw.githubusercontent.com/imbahere/default/menu' && \
